...
function Card(props){
    ...
    return (
        <>
            ...
            <div>
            <Link to={`/cake/${props.cake.cakeid}`}><a  href="https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHw%3D&w=1000&q=80" className="btn btn-primary mr-3">Details</a></Link>
